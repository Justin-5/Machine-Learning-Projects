...
MODEL=load_model("Handwritten_Digit_Recognition//best_model.h5")
...
# FIX 1: Use SysFont with correct capitalization
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == MOUSEBUTTONUP:
            ...
            # Prevent crashing if the user just clicks without drawing
            ...
            # FIX 4: Correctly calculate the bounding box
            ...
            if IMAGESAVE:
                # FIX 5: Add image data to imwrite and use correct variable
            ...
            if PREDICT:
                ...
                # FIX 2: Get rect from the correct surface
                textRecObj = textSurface.get_rect()
                textRecObj.left, textRecObj.bottom = rect_min_x, rect_max_y

                DISPLAYSURF.blit(textSurface, textRecObj)

        # FIX 3: Un-indent the KEYDOWN check to the main event loop
